...
def tables_exist():
    ...
    if not result:
        error_msg = "table tenants does not exist"
        logging.error(error_msg)
    ...
    if not result:
        error_msg = "table vms does not exist"
        logging.error(error_msg)
        return error_msg, False
    ...
    if not result:
        error_msg = "table privileges does not exist"
        logging.error(error_msg)
        return error_msg, False
    ...
    if not result:
        error_msg = "table volumes does not exist"
        logging.error(error_msg)
        return error_msg, False
